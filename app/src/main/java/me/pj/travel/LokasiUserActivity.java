...
public class LokasiUserActivity extends AppCompatActivity {
...
/*ADAPTER LIST*/
    ...
    public void showDataDetail(final Jadwal news){
        ...
        alert.setPositiveButton("Buka Peta", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int id) {
                tampilPeta(news.getDriver());
                dialog.dismiss();
            }
        });
        alert.show();
...
/*TAMPIL PETA*/
    private void tampilPeta(String driver) {
        Intent i = new Intent(LokasiUserActivity.this, LokasiDriverUserActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lokasi_user);
